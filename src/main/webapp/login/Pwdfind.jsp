...
<html lang="ko">
  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:25rem; background-color:transparent; border-color:white;">
      ...
      <form method="get" action="../controller/pwd.do">
        <div class="checkbox">
        ...
        <input type="text" name="email" id="email" class="form-control" placeholder="이메일을 입력하세요"  required><br>
         ...
         <select class="form-select" name="hint"  id="hint"  style="width: 338px; color: gray;">
        ...
        <input type="text" name="hint_asw" id="hint_asw" class="form-control" placeholder="힌트 질문에 대한 답을 입력하세요"  ><br>
	        	 ...
	        	 <button type="submit" id="btn-Yes" class= "btn btn-lg btn-primary btn-block"  onclick="searchPwd()">비밀번호 찾기</button>
      </form>
